...
export default function Home() {
  ...
  return (
    <main className="relative flex w-screen h-full overflow-hidden items-center justify-center bg-gray-950">
      ...
      {!isLoginOpen && (
        <div className="absolute md:bottom-10 md:right-10 md:z-10 w-auto sm-flex sm-justify-end sm-items-center">
          <PrimaryButton 
