                        ...
                        <FilterGrid>
                            ...
                            <FilterCard>
                                ...
                                {uniqueGraduations.length > 0 && (
                                    <ButtonGroup>
                                        <FilterButton $active={graduationFilter === 'all'} $colorType="cyan" onClick={() => setGraduationFilter('all')}>
                                            Todos
                                        </FilterButton>
                                        {uniqueGraduations.map(grad => (
                                            <FilterButton key={grad} $active={graduationFilter === grad} $colorType="cyan" onClick={() => setGraduationFilter(grad)}>
                                                {grad}
                                            </FilterButton>
                                        ))}
                                    </ButtonGroup>
