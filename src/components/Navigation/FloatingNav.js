...
import { Menu, X, Home, LogOut, Users, NotebookPen, ArrowBigLeft, User, AlertTriangle, Trophy } from 'lucide-react';
...
export default function FloatingNav() {
  ...
  const options = [
    ...
    { name: 'Ranks', path: '/ranks', icon: <Trophy />, color: 'rgba(100, 100, 100, 0.5)' },
